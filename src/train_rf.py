...
def build_pipeline(numeric_cols, random_state: int):
...
def main(
    ...
    pipe = build_pipeline(numeric_cols, random_state=random_state)
...
if __name__ == "__main__":
    ...
    p.add_argument("--model-out", type=str, default="models/rf.joblib")
